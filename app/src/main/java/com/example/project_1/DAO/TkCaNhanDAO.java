...
public class TkCaNhanDAO {
    private SQLiteDatabase db;
    private DatabaseHelper dbHelper;
    //    ten table
    public static final String TABLE_NAME = "TkCaNhan";
    //    create table
    public static final String SQL_TK_CA_NHAN = "CREATE TABLE \"tkCaNhan\" (\n" +
            "\t\"maNguoiDung\"\tTEXT,\n" +
            "\t\"tenNguoiDung\"\tTEXT NOT NULL,\n" +
            "\tPRIMARY KEY(\"maNguoiDung\")\n" +
            ");";
    public static final String TAG = "TkCaNhanDAO";

    public TkCaNhanDAO(Context context) {
